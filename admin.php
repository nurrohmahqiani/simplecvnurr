...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  mysqli_stmt_bind_param($stmt, "sssssssss", $nama, $alamat, $telepon, $email, $web, $pendidikan, $pendidikan_sma, $pengalaman_kerja, $prestasi, $prestasi_lagi, $foto_path);
...
<body class="p-3">
  <!-- <div class="container mt-5"> -->
    <br> <br> <br> <br>
    <nav class="navbar sticky-top bg-body-tertiary birulg">
      <div class="container-fluid">
        <h1>Update CV</h1>
        <a class="navbar-brand" href="/cv-main">View</a>
      </div>
    </nav>
    <div class="card">
      <div class="p-3">
        <div class="card-body">
          <form method="post">
            <div class="mb-3">
              ...
              <textarea class="form-control" id="prestasi" name="prestasi" rows="3" placeholder="prestasi" required><?php echo $data['prestasi']; ?></textarea>
